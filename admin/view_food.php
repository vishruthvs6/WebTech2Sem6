<?php 
    ...
    if (isset($_GET['category'])) {
       ...
       if ($category == "sanman") {
          $sql = "SELECT * FROM item WHERE category='sanman' AND im_id NOT IN (SELECT im_id FROM todays_special WHERE date='$dat')";
       }
       elseif ($category == "sagar") {
          $sql = "SELECT * FROM item WHERE category='sagar' AND im_id NOT IN (SELECT im_id FROM todays_special WHERE date='$dat')";   
       }
       elseif ($category == "agarwal") {
          $sql = "SELECT * FROM item WHERE category='agarwal' AND im_id NOT IN (SELECT im_id FROM todays_special WHERE date='$dat')";
       }
       elseif ($category == "ts") {
                ...
                <div class="col-md-12">
                    ...
                    <?php if (!empty($rows)): ?>
                         ...
                         <h4 class="text-muted mt-3 p-1">
                            Food items for Restaurant "<?php echo ($category=='ts')? "today's special" : $category;?>"...

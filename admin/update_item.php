                ...
                <form method="POST" action="update_item.php" id="update_item">
                  ...
                  <div class="form-group">
                     ...
                     <select class="form-control" id="category" name="category" required="required">
                      ...
                      <?php if($row['category'] == "sanman"): ?>
                            <option value="sanman" selected="selected">Sanman</option>
                            <option value="sagar">Sagar</option>
                            <option value="agarwal">Agarwal</option>

                      <?php elseif($row['category'] == "sagar"): ?>
                            <option value="sanman">Sanman</option>
                            <option value="sagar" selected="selected">Sagar</option>
                            <option value="agarwal">Agarwal</option>
                       
                      <?php else: ?>
                            <option value="sanman">Sanman</option>
                            <option value="sagar">Sagar</option>
                            <option value="agarwal" selected="selected">Agarwal</option>

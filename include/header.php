...
<div class="jumbotron jumbotron-fluid">
 <div class="container">
   <h1 class="display-2 text-light">Food Paradise</h1>
   <h3 class="text-light">Order food online from the following restaurants</h3>
 </div>
</div>
      ...
      <ul class="navbar-nav mr-auto mt-2 mt-md-0">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="browse_food.php?category=sanman">Sanman</a>
            <a class="dropdown-item" href="browse_food.php?category=sagar">Sagar</a>
            <a class="dropdown-item" href="browse_food.php?category=agarwal">Agarwal</a>
          </div>
        </li>
